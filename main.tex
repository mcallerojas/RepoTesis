...
\textbf{Financiera} & Incrementar el volumen de ventas en 10 \% mediante la diversificación de mercado & \multirow{3}{3cm}{\\Implementar estrategias de venta mediante diversificación de portafolio de productos}\\ \cline{1-2}
...
\textbf{Procesos Internos} & Implementar una sección control de procesos para optimizar tiempos en un 15\% & \multirow{5}{3cm}{\\Implementar procesos estandarizados de producción} \\ \cline{1-2}
...
\textbf{Aprendizaje y conocimiento} & Establecer métodos de reconocimiento y recompensa & \multirow{2}{3cm}{Realizar procesos de evaluación al personal} \\ \cline{1-2}
...
Participación reducida en el mercado provincial. & Incrementar volumen de ventas en productos y servicios & \multirow{3}{4cm}{\\Implementar estrategias de venta y diversificación de portafolio de productos} \\ \cline{1-2}
