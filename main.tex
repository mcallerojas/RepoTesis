...
\textbf{Financiera} & Incrementar el volumen de ventas en 10 \% mediante la diversificación de mercado & \multirow{3}{4.5cm}{\\Implementar estrategias de venta mediante diversificación de portafolio de productos}\\ \cline{1-2}
